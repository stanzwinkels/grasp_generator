...
from grasp_generator.utils.reasoning import Reasoning_version2
...
class Main:
    ...
    def run(self):
        ...
        # Prolog reasoning
        prolog_reasoning = Reasoning_version2()
        request_ID, grasp_region = prolog_reasoning.shape_selection(superquadrics, self.task, semantic_shape)
