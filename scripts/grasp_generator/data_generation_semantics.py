...
"""
This is a stand-alone python that is used to recover and label primitive shapes into cuboids, cylinders, and spheres. 
...
if data_generation:
    ...
    for superquadric in superquadrics:
        ...
        title = (
            str(count)
            + "/"
            + str(len(superquadrics))
            + ": Please choose crresponding shape: "
        )
