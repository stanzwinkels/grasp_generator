    ...
    for i in range(len(pointclouds)):          # for pointcloud in iteration 30
        try: 
            ...
            if len(superquadrics) == 2: 
                ...
                total_score = (total_size_diff_norm)
                print("iteration pointcloud: " + str(i+1) + "/" + str(len(pointclouds)) + ", size score: " + str(total_size_diff_norm))
...
if __name__ == "__main__":
    ...
    directory_yaml = package_path + "/config/experiment_products_real.yaml"
    directory_product = package_path + "/data/real_data/limonade/"
