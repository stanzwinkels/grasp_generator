    ...
    def run(self):
        ...
        for filename in os.listdir(directory_product):
            ...
            #         self.package_path + "/data/test_data")
                ...
                correct_filt_superquadrics = filt_superquadrics
                ...
                request_ID, region, forms = prolog_reasoning.shape_selection(
                    correct_filt_superquadrics, self.product, self.task)
                ...
                book = load_workbook('data_shapes.xlsx')
                writer = ExcelWriter('data_shapes.xlsx', engine='openpyxl')
                writer.book = book
